...
class Resort(models.Model):
    name = models.CharField("resort name", max_length = 25)
    location = models.CharField(max_length = 30)
    # resort_weather = models.ForeignKey(Resort_Weather, on_delete = models.CASCADE)
...
class Resort_Weather(models.Model):
    ...
    twelve_hour_snow = models.CharField(max_length = 50)
    twenty4_hour_snow = models.CharField(max_length = 50)
    base = models.CharField(max_length = 50)
    total_snow = models.CharField(max_length = 50)
    current_temp = models.CharField(max_length = 50)
